...
class MainMenuState extends MusicBeatState
{
	...
	var optionShit:Array<String> = ['story_mode','freeplay','gallery','ost','credits','options'];
	...
	override function create()
	{
		...
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, "Vs House Official Build", 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
	...
	override function update(elapsed:Float)
	{
		...
		if (!selectedSomethin)
		{
								...
								switch (daChoice)
								{
									...
									case 'gallery':
										...
										new FlxTimer().start(0.3, function(tmr:FlxTimer) {
											FlxG.sound.playMusic(Paths.music('gallerySong'), 1);
            ...
            //             {
			//  	selectedSomethin = true;
			//  	MusicBeatState.switchState(new CharacterChooser());
            //             }
			// hujnia - hooovie
		}
