...
class FreeplayState extends MusicBeatState
{
	...
	{		
		...
		scoreText = new FlxText(FlxG.width * 1, 5, 0, "", 32);
	...
	override function update(elapsed:Float)
	{
		...
		else if (accepted)
		{
			...
			if (FlxG.keys.pressed.SHIFT){
				...
				{
					PlayState.SONG.player1 = 'housemulti';
					PlayState.SONG.gfVersion = 'nogf';
					LoadingState.loadAndSwitchState(new PlayState());
				}
				else if (PlayState.SONG.song == 'fundament')
					{
						PlayState.SONG.player1 = 'housebf';
						PlayState.SONG.gfVersion = 'nogf';
						LoadingState.loadAndSwitchState(new PlayState());
					}
					else if (PlayState.SONG.song == 'renovation')
						{
							PlayState.SONG.player1 = 'bfrenovation'; 
							PlayState.SONG.gfVersion = 'nogf';
							LoadingState.loadAndSwitchState(new PlayState());
						}else{
				LoadingState.loadAndSwitchState(new CharacterChooser());
			}
